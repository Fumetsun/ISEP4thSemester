...
public class ServerCustomerOffersHandler {
    ...
    public ServerCustomerOffersHandler(String password) {
        this.password = password;
    }

    public Iterable<MessageDTO> getMyOffers() {
        ...
        try (ObjectOutputStream sOut = new ObjectOutputStream(sock.getOutputStream());
            ...
            SystemUser user = authz.loggedinUserWithPermissions(BaseRoles.CUSTOMER).get();
