...
public class ApplicationBuilder implements DomainFactory<JobApplication> {
    ...
    private JobApplication buildOrThrow() {
        ...
        if (/*refCode*/email != null && filesPath != null && attachedFile != null && jobOffer != null && candidate != null && applicationState != null && interviewGrade != null) {
    ...
    public ApplicationEmail getEmail() {
        return this.email;
    }

    @SuppressWarnings("all")
    public ApplicationFilesPath getFilesPath() {
        return this.filesPath;
    }

    @SuppressWarnings("all")
    public ApplicationAttachedFile getAttachedFile() {
