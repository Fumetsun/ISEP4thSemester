# 1220962 - Alfredo Ferreira - Sprint A - Self Assessment
...
**Justification and Evidences: Every action used in the workflow implemented was picked with a reason and justified in the READ.me document, their purpose and function was also detailed step by step in the same document.**
...
**Justification and Evidences: Mostly the commits are significant but had some issues with smart commits at the start.**
...
**Justification and Evidences: Every aspect of sprint A was thought out and developed as a team with everyone chipping in one way or another. The tasks were assigned before the end of the first week.**
...
**Justification and Evidences: Sprint A does not include User Stories that actually build upon the structure of the code but instead mostly setup tasks, with that said the setup tasks I performed are all documented and run on any enviroment since they are all server side on the repository.**
...
**Justification and Evidences: The workflow implemented perfectly captures all key points the client wanted when he talked about the objective and purpose of the user story, these functionalities are all done by separate jobs and each job has a clear and cut purpose.**
...
**Justification and Evidences: Every User Story was thoroughly analyzed and discussed with the team, the team after hard many talks and exchanges with the client that resulted in a deeper and better understanding of the domain and scope of the business aswell as the requirements and expectations regarding the issues for sprint A.**