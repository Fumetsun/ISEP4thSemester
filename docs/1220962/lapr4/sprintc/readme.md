# 1220962 - Alfredo Ferreira - Sprint C - Self Assessment
...
**Justification and Evidences: Great care was taken when it came to the development and upkeeping of the documentation, the diagrams and pieces of documentation created were built with the design intentions of being incredibly easy to understand whilst not missing any key piece of information, all the while making sure design patterns and good practices were drilled into the design process.**
...
**Justification and Evidences: All commits follow the agreed upon "[US] - Explanation" format so as to make them more easily readable, each commit regarding the fix/realization of an open issue was made sure to close that issue with a git command.**
...
**Justification and Evidences: The team made every major design decision as a group in scheduled meetings, every decision is documented, every global design pattern agreed upon is registered, every issue assigned to more than 1 person had the collaboration of everyone involved in all parts of the development process.**
...
**Justification and Evidences: The system runs flawlessly on windows 10/11, linux and DEI cloud hosting services through SSH.**
...
**Justification and Evidences: The entire system functions as per the explained vision of the client, the code follows good practices, is well documented and the relationship of design-code is near 1 to 1.**
...
**Justification and Evidences: Every requirement and every acceptance criteria was met in full, additional acceptance criteria extra to what the client requested were also added and followed as per team discussion to ensure the best execution flow possible.**