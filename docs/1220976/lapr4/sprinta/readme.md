# 1220976 - Ricardo Dias - Sprint A - Self Assessment
...
**Justification and Evidences:** I wasn't tasked to programm anything, only to implement features in the github repository and to write the documentation for those tasks.
...
**Justification and Evidences:** Every commit I sent was explicitly written detailing every file that was sent. I did not use issue, because my tasks only required the creation of documentation.
...
**Justification and Evidences:** Every choice was debated as a team. No one would start working in something without warning and the repository wasn't altered without permission of every member. We also relied on each other to question and help when needed, even if it wasn't our US.
...
**Justification and Evidences:** Although we don't have the actual program, the template is functioning outside the IDE without failure and while using the correct version.
...
**Justification and Evidences:** We don't have it yet, so we can't self-avaluate.
...
**Justification and Evidences:** We haven't done it yet, but we are confident in our work.