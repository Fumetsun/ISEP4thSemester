# 1220976 - Ricardo Dias - Sprint C - Self Assessment
...
**Justification and Evidences:** I know that everything is working and I'm proud of the work I've done. I don't select 5, because I might have missed something, but overall I think I did everything correctly.
...
**Justification and Evidences:** Every commit was complete with each action specified and the meaning behind it. In terms of commits, I think there wasn't anything more that should be done to improve it.
...
**Justification and Evidences:** Every choice was debated as a team. No one would start working in something without warning and the repository wasn't altered without permission of every member. We also relied on each other to question and help when needed, even if it wasn't our US. Every main decision and project defining meeting was also recorded to prove this.
...
**Justification and Evidences:** We tested in every environment required, and it works, even in the cloud.
...
**Justification and Evidences:** I am not sure if the integration is "perfectly documented". Everything IS well documented, but it's possible to be missing something. 
...
**Justification and Evidences:** We are confident we did everything that was asked, and every functionality is implemented. We tested what we could test, but there are some tests that we wanted to do, but weren't able thanks to the Framework.